INSERT INTO public.users (id, username, email, password, role, modified_by, created_at, created_by, modified_at)
...
VALUES (1, '1', 'Semen', 'Kobelev', '21 Lebedyanskya st', '7212112390', '+1 720 123 45 90', '1995-07-22 00:00:00', '2023-07-03 10:00:00', 1, '2023-07-03 10:00:00', 1, '2023-07-03 10:00:00'),
...
INSERT INTO public.driver_license (id, user_details_id, number, issue_date, expired_date)
VALUES (1, '1', '12345AB', '2015-03-02 00:00:00', '2025-03-01 00:00:00'),
       (2, '2', '12345BD', '2014-03-02 00:00:00', '2024-12-01 00:00:00');
...
VALUES (1, '1', 'HOURS', 1000),
       (2, '2','HOURS', 10000);
SELECT SETVAL('car_rate_id_seq', (SELECT MAX(id) FROM car_rate));
...
SELECT SETVAL('damage_id_seq', (SELECT MAX(id) FROM damage));